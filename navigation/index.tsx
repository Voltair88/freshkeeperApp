  ...
  >
   <BottomTab.Screen
    ...
    options={({ navigation }: RootTabScreenProps<'TabOne'>) => ({
     ...
     tabBarIcon: ({ color }) =>
      useIsFocused() ? <TabBarIcon2 name="cart" color={color} /> : <TabBarIcon2 name="cart-outline" color={'white'} />,
     headerRight: () =>
      auth.currentUser ? (
       <Pressable
   ...
   <BottomTab.Screen
    ...
    options={({ navigation }: RootTabScreenProps<'TabThree'>) => ({
     ...
     tabBarIcon: ({ color }) =>
      useIsFocused() ? <TabBarIcon2 name="food" color={color} /> : <TabBarIcon2 name="food-outline" color={'white'} />,
     headerRight: () =>
      auth.currentUser ? (
       <Pressable
        onPress={() => navigation.navigate('Account')}
